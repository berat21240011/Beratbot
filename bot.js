...
client.on("ready", () => {
 ...
 client.user.setActivity(client.guilds.cache.size + ` Sunucu, ` + client.guilds.cache.reduce((a, b) => a + b.memberCount, 0).toLocaleString() + ` Kişiye Hizmet Veriyorum!`);
})
...
client.login(process.env.token)
  ...
  client.on("ready", () => {
  client.channels.cache.get("838362063927377981").join();//sesli bi kanala katılacagı icin kanal ID si
}) 
